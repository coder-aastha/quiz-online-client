...
import { fetchQuizForUser } from "../utils/QuizService.tsx"
import AnswerOptions from "../utils/AnswerOptions.tsx";
...
export const Quiz: React.FC = () => {
  ...
  const { selectedSubject, selectedNumQuestions } = location.state as {
    selectedSubject: string;
    selectedNumQuestions: string;
  };
  ...
  const handleCheckboxChange = (questionId: string, choice: string | string[]) => {
    setSelectedAnswers((prevAnswers) => {
      const existingAnswerIndex = prevAnswers.findIndex(
          (answerObj) => answerObj.id === questionId
      );
